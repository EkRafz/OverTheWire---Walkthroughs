...
| [Level 24 → 25](Walkthroughs/natas-level-24-level-25.md) | Path traversal, filter bypass via double `../`, log poisoning         | ✅      |
| [Level 25 → 26](Walkthroughs/natas-level-25-level-26.md) | PHP object injection, `__destruct()`, cookie-stored serialized object | ✅      |
| [Level 26 → 27](Walkthroughs/natas-level-26-level-27.md) | MySQL truncation, trailing-space collision, duplicate user creation   | ✅      |
| [Level 27 → 28](Walkthroughs/natas-level-27-level-28.md) | AES-ECB block splicing, block boundary manipulation, SQL injection    | ✅      |
| [Level 28 → 29](Walkthroughs/natas-level-28-level-29.md) | Perl `open()` injection, null-byte suffix bypass, filter evasion      | ✅      |
| [Level 29 → 30](Walkthroughs/natas-level-29-level-30.md) | Perl `quote()` type confusion, `param()` list flattening              | ✅      |
| [Level 30 → 31](Walkthroughs/natas-level-30-level-31.md) | `ARGV` filehandle hijack, `param()` multi-value, phar stream          | ✅      |
| [Level 31 → 32](Walkthroughs/natas-level-31-level-32.md) | Same `ARGV` attack, RCE, setuid binary execution                      | ✅      |
| [Level 32 → 33](Walkthroughs/natas-level-32-level-33.md) | Phar deserialization, `md5_file()` sink, `__destruct()` gadget        | ✅      |
| [Level 33 → 34](Walkthroughs/natas-level-33-level-34.md) | End of series                                                         | ✅      |
